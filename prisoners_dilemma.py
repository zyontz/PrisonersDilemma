...
import player0
player_0 = player0.Player0()
import player1
player_1 = player1.Player1()
import player2
player_2 = player2.Player2()
import player3
player_3 = player3.Player3()
import player4
player_4 = player4.Player4()
import player5
player_5 = player5.Player5()
import player6
player_6 = player6.Player6()
import player7
player_7 = player7.Player7()
import player8
player_8 = player8.Player8()
import player9
player_9 = player9.Player9()
import player10
player_10 = player10.Player10()
import player11
player_11 = player11.Player11()
import player12
player_12 = player12.Player12()
import player13
player_13 = player13.Player13()
import player14
player_14 = player14.Player14()
import player15
player_15 = player15.Player15()
import player16
player_16 = player16.Player16()
import player17
player_17 = player17.Player17()
...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
   ...
   # EACH STUDENT TEAM CAN CHANGE ONE OF THESE elif SEGMENTS OF CODE.   
    ...
    if player == 0:
        return player_0.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #This example player always betrays.      
        ...
        return player_1.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #only betrays if they were a sucker last round.
        ...
        return player_2.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_3.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_4.strategy(history, opponent_history, score, opponent_score, getting_team_name) 
    ...
    #
        ...
        return player_5.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_6.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_7.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_8.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_9.strategy(history, opponent_history, score, opponent_score, getting_team_name)
       
    ######
    ######
    #
    elif player == 10:
        return player_10.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_11.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_12.strategy(history, opponent_history, score, opponent_score, getting_team_name)
    ...
    #
        ...
        return player_13.strategy(history, opponent_history, score, opponent_score, getting_team_name)
       
    ######
    ######
    #
    elif player == 14:
        return player_14.strategy(history, opponent_history, score, opponent_score, getting_team_name)
       
    ######
    ######
    #
    elif player == 15:
        return player_15.strategy(history, opponent_history, score, opponent_score, getting_team_name)
        
    ######
    ######
    #
    elif player == 16:
        return player_16.strategy(history, opponent_history, score, opponent_score, getting_team_name)
       
    ######
    ######
    #
    elif player == 17:
        return player_17.strategy(history, opponent_history, score, opponent_score, getting_team_name)
       

def play_tournament(num_players):
    #create a list of zeros, one per player
    if num_players > 18:
        print('A maximum of 18 players are allowed')
        return
